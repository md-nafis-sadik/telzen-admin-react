...
const revenueSlice = createSlice({
  ...
  initialState,
  reducers: {
    setRevenueDataList: (state, action) => {
    ...
    addNewRevenueToList: (state, action) => {
      const newRevenue = {
        ...action.payload,
    ...
    setRevenueCardData: (state, action) => {
      state.revenueCardData = action.payload.data;
    },

    updateRevenueInList: (state, action) => {
    ...
    removeRevenueFromList: (state, action) => {
    ...
    setRevenueMetaData: (state, action) => {
    ...
    setSelectedRevenueData: (state, action) => {
      state.selectedData = action.payload;
    },
    // Reset selectedData when needed
    clearSelectedRevenueData: (state) => {
      state.selectedData = null;
    },
    // Add the missing confirmation modal action
    setRevenueConfirmationModal: (state, action) => {
...
export const {
  ...
  addNewRevenueToList,
  updateRevenueInList,
  removeRevenueFromList,
  setRevenueMetaData,
  setRevenueCardData,

  setSelectedRevenueData,
  clearSelectedRevenueData,
  setRevenueConfirmationModal,

...
const packageKeepgoSlice = createSlice({
  name: "packageKeepgo",
  initialState,
  reducers: {
    setKeepgoPackageDataList: (state, action) => {
      state.dataList = action.payload.data;
    },

    setKeepgoPackageData: (state, action) => {
    ...
    addNewKeepgoPackageToList: (state, action) => {
      const newPackage = {
        ...action.payload,
    ...
    updateKeepgoPackageInList: (state, action) => {
    ...
    removeKeepgoPackageFromList: (state, action) => {
    ...
    setKeepgoPackageMetaData: (state, action) => {
    ...
    setSelectedKeepgoPackageData: (state, action) => {
      state.selectedData = action.payload;
    },
    // Reset selectedData when needed
    clearSelectedKeepgoPackageData: (state) => {
      state.selectedData = null;
    },
    // Add the missing confirmation modal action
    setKeepgoPackageConfirmationModal: (state, action) => {
...
export const {
  setKeepgoPackageDataList,
  setKeepgoPackageData,
  ...
  clearSelectedKeepgoPackageData,
  setKeepgoPackageConfirmationModal,
} = packageKeepgoSlice.actions;
export default packageKeepgoSlice.reducer;

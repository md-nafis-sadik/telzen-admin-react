...
const BlockConfirmationModal = ({ handleStatus, modalClose, title }) => {
  return (
    <section>
      <input
        type="checkbox"
        id="blockConfirmationPopup"
      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box w-[550px] flex flex-col items-center justify-center gap-6 bg-white px-12 py-8">
          ...
          <div className="text-center">
            <h4 className=" text-errorColor text-4xl font-bold ">Block</h4>
            <p className="text-2xl text-blackLow mt-2">
              Are you sure to block the {title}?
            </p>
          </div>
          <div className="modal-action flex items-center justify-center gap-6">
            <label
              htmlFor="blockConfirmationPopup"

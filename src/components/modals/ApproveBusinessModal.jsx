...
import { ExclaimCircleIcon } from "../../utils/svgs";
...
const ApproveModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div
        className={`relative bg-white rounded-2xl w-[90%] max-w-[486px] px-6 py-8 flex flex-col items-center gap-6 ${
          isClosing ? "modal-content-closing" : "modal-content-animate"
        }`}
      >
        <div className="flex items-center justify-center">
          <ExclaimCircleIcon w="74" h="74" />
        </div>

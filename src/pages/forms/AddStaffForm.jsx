...
import { useAddStaff } from "../../hooks/features/useStaffs";
  ...
  return (
    <section className="px-8 py-6 h-full overflow-auto">
      <div className="bg-white p-6 rounded-2xl">
        <BackToPrev path="/staffs" title="Add Staff"></BackToPrev>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className={`w-full border placeholder:text-disabled ${errors.name ? "border-red-500" : "border-natural-400"
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className={`w-full border placeholder:text-disabled ${errors.email ? "border-red-500" : "border-natural-400"
            ...
            <div className="flex flex-col gap-1">
              ...
              <Select
                className={`w-full border ${errors.role ? "!border-red-500" : "border-natural-400"
                  } rounded-lg

...
import { useUpdateKeepgoPackage } from "../../hooks/features/useKeepgoPackages";
import { currency, getSymbol } from "../../utils/currency";

function UpdateKeepgoPackageForm() {
  const {
    isModalVisible,
    handleChange,
    handleSubmit,
    ...
    sortedRegions,
    finalPrice,
  } = useUpdateKeepgoPackage();

  return (
    <section className="px-8 py-6 h-full overflow-auto">
      <div className="bg-white p-6 rounded-2xl">
        <BackToPrev path="/keepgo-packages" title="Update Package"></BackToPrev>
...
export default UpdateKeepgoPackageForm;

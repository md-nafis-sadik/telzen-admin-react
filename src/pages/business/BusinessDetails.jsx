            ...
            {isLoading ? (
              ...
              <>
                <div className="bg-white rounded-2xl p-4 h-32">
                  <p className="text-base text-black-700 mb-1">Total Customers</p>
            ...
            <div className="mb-4">
              ...
              >
                {transactionData.map((order, index) => (
                  <tr
                    className={`bg-white text-blackSemi relative ${index !== transactionData.length - 1
                  ...
                  >
                    ...
                    <td className="py-4">
                      {getSymbol(order.payment_currency)}{order.payment_amount}
                    </td>
                    <td className="py-4">
                      {getSymbol(order.payment_currency)}{order.revenue}
                    </td>
                  </tr>
                ))}
              </CustomTable>
